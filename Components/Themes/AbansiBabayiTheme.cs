...
namespace IA_AbansiBabayiSystemBlazor.Components.Themes
{
    public class AbansiBabayiTheme
    {

        public static readonly MudTheme AbansiBabayiCustomTheme = new()
        {
            PaletteLight = new PaletteLight()
            {
                ...
                PrimaryDarken = "#09400bff",
                PrimaryLighten = "#159b19ff",
                SecondaryDarken = "#1f8222ff",
                SecondaryLighten = "#36e03bff",
                TertiaryDarken = "#31b669ff",
                TertiaryLighten = "#3cdb7eff",
